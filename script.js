...
const multiPost = document.querySelector('.multi-post');
const projectCardOne = document.querySelector('.project-card');
const projectCards = document.querySelector('.project-card.two');
